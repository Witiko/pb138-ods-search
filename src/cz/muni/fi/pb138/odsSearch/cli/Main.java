...
public class Main {
   ...
   public static Options constructGnuOptions()
   {
      ...
      // TODO set string as required
      gnuOptions.addOption("i", "case-sensitive", false, "Use case sensitive search")
                .addOption("x", "exact-match", false, "Use exact match search")
                .addOption("s", "string", true, "String to be used for search")
      ...
      final String[] commandLineArguments)
   {
      ...
      try
      {
         ...
         {
            System.out.println("Prohledávač souborů Open Document Spreadsheet\n");
            printHelp(
   ...
   public static void printHelp(
      ...
      final OutputStream out)
   {
      final String commandLineSyntax = "java -cp pb138-ods-search.jar";
      final PrintWriter writer = new PrintWriter(out);
